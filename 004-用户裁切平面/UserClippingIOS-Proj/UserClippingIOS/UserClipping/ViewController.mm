...
- (void)viewDidLoad
{
    ...
    [localClipPlaneSlider setValue:UserClipDistance];
    localClipPlaneSlider.minimumValue = -2.0;// 设置最小值
    localClipPlaneSlider.maximumValue = +2.0;// 设置最大值
    ...
    [sliderLabel setText:[NSString stringWithFormat:@"裁切距离 %.1f",UserClipDistance]];
...
- (void)doSliding:(id)sender {
    UserClipDistance = [(UISlider *)sender value];
}
