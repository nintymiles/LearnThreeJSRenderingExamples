...
public:
    ...
    virtual bool Activate(GLuint textureUnit);
 ...
 */
bool TextureCubemap::Activate(GLuint textureUnit) {
    assert(texId_ != GL_INVALID_VALUE);
    
    glBindTexture(texId_, textureUnit);
...
bool Texture2d::Activate(GLuint textureUnit) {
    //glBindTexture(texId_, textureUnit);
