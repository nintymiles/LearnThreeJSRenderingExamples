...
shared_ptr<MultiPassScene> depthTextureModel;
...
static void drawStuff() {
    ...
    depthTextureModel->Render();
//    torusModel->RenderMultiInsances();
...
static void reshape(const int w, const int h) {
    ...
    depthTextureModel->setPerspectiveCamera(mainCamera);
    depthTextureModel->InitModel();
...
static void initGeometry() {
    depthTextureModel.reset(new MultiPassScene());
